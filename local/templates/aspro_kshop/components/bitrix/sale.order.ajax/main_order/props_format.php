                    ...
                    <div data-property-id-row="<?=intval(intval($arProperties["ID"]))?>">
                        ...
                        <?
                            ...
                            <div class="bx_block r3x1">
                                <input type="text" code="<?=$arProperties["CODE"]?>" maxlength="250" size="<?=$arProperties["SIZE1"]?>" value="<?=$arProperties["VALUE"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>" />
                            ...
                            <div class="bx_block r3x1">
                                <select code="<?=$arProperties["CODE"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>" size="<?=$arProperties["SIZE1"]?>">
                                    <?
                            ...
                            <div class="bx_block r3x1">
                                <select code="<?=$arProperties["CODE"]?>" multiple name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>" size="<?=$arProperties["SIZE1"]?>">
                                    <?
                                        foreach($arProperties["VARIANTS"] as $arVariants):
                                        ?>
                                        <option value="<?=$arVariants["VALUE"]?>"<?if ($arVariants["SELECTED"] == "Y") echo " selected";?>><?=$arVariants["NAME"]?></option>
                            ...
                            elseif ($arProperties["TYPE"] == "TEXTAREA")
                            {
                                ...
                                <div class="hidden-block">
                                    <textarea code="<?=$arProperties["CODE"]?>" rows="<?=$rows?>" cols="<?=$arProperties["SIZE1"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>">-</textarea>
                                </div>
                                <?
                                } else {
                                    $rows = ($arProperties["SIZE2"] > 10) ? 4 : $arProperties["SIZE2"];
                                ...
                                <div class="bx_block r3x1">
                                    <textarea code="<?=$arProperties["CODE"]?>" rows="<?=$rows?>" cols="<?=$arProperties["SIZE1"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>"><?=$arProperties["VALUE"]?></textarea>
