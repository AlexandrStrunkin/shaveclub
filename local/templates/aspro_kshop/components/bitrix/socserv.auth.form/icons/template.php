...
<div class="row clearfix">
	<?foreach($arParams["~AUTH_SERVICES"] as $service):?>
		...
		?>
		<a title="<?=htmlspecialcharsbx($service["NAME"])?>" href="javascript:void(0)"  <?=$onClickEvent?> class="button30 <?=htmlspecialcharsbx($service["ICON"])?>" type="<?=htmlspecialcharsbx($service["ICON"])?>" id="bx_auth_href_<?=$arParams["SUFFIX"]?><?=$service["ID"]?>">
