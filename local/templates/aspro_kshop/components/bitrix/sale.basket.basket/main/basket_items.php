							...
							?>
								<td class="backet_back_wrapp">
									<div class="basket_back">
										<a class="button30 gradient back_button" href="<?=SITE_DIR?>catalog/"><span><?=GetMessage("SALE_BACK")?></span></a>
								...
								<td class="basket_checkout_wrapp">
									<?if ($arParams["SHOW_FULL_ORDER_BUTTON"]=="Y"):?>
										<div class="basket_checkout clearfix">
											<a href="javascript:void(0)" class="button30 gradient checkout" onclick="checkOut();"><span><?=GetMessage("SALE_ORDER")?></span></a>
