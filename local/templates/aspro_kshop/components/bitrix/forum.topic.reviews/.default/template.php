...
<script type="text/javascript">
	BX.ready(function(){
		...
		<?if($arResult["ELEMENT"]["PRODUCT"]["PROPERTY_FORUM_MESSAGE_CNT_VALUE"]){?>
			$('#product_reviews_tab .count.empty').html('&nbsp; (<?=$arResult["ELEMENT"]["PRODUCT"]["PROPERTY_FORUM_MESSAGE_CNT_VALUE"];?>)');
		<?}?>
	});
</script>
<?
