        ...
        <div class="bx_rt">
            ...
            <?
                ...
                if (isset($arResult['OFFERS']) && !empty($arResult['OFFERS']) && !empty($arResult['OFFERS_PROP']))
                {
                    $arSkuProps = array();
                ?>
                <div class="item_info_section_offers">
                    <h4>Доступные комплектации для заказа:</h4>
                    <div class="item_info_section " style="padding:0 150px 0 0;" id="<? echo $arItemIDs['PROP_DIV']; ?>">
                        <?
            ...
            <div class="item_info_section" style="padding-left:2px">
                <?
                    if (isset($arResult['OFFERS']) && !empty($arResult['OFFERS']))
                    {
                    ...
                    <div class="item_buttons vam">
                        <span class="item_buttons_counter_block">   
                            <span class="catalog_item_props_block" >
                            ...
                            <span class="bx_cnt_desc" id="<? echo $arItemIDs['QUANTITY_MEASURE']; ?>" style="line-height: 25px"><? echo (isset($arResult['CATALOG_MEASURE_NAME']) ? $arResult['CATALOG_MEASURE_NAME'] : ''); ?></span>
