                        ...
                        ?>        
                            <div class="bx_element">
                                ...
                                <div class="item <?if($arProfile["CHECKED"] == "Y"){?>active<?}?>">
                                    <div class="price"><?=$arProfile["RICE"]?> <span class="rouble">i</span></div>
                                    <span class="item-title"><?=$arProfile["NAME"]?></span>
                    ...
                    <div class="bx_element">   
                        ...
                        <label for="ID_DELIVERY_ID_<?=$arDelivery["ID"]?>" <?=$clickHandler?>>  
                            ...
                            <div class="item <?if($arDelivery["CHECKED"] == "Y"){?>active<?}?>">
                                <div class="price"><?=$arDelivery["PRICE"]?> <span class="rouble">i</span></div>
