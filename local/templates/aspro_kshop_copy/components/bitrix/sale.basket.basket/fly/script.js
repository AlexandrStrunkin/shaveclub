	...
	if (typeof result != "undefined") {
		...
		if ($(newBasket).length) {			
			...
			if (action=="update") {
                ...
                } else if ($(newBasket).find("input[name=COUPON]").val() && $(oldBasket).find("input[name=COUPON]").val() 
				...
				$(arDasketIDs).each(function(i, basketId) {
					...
					if(parseInt(delSpaces($(oldBasket).find("tr[data-id="+basketId+"] .cost-cell .price:not(.discount)").text())) != parseInt(delSpaces($(newBasket).find("tr[data-id="+basketId+"] .cost-cell .price:not(.discount)").text()))) {
						$(oldBasket).find("tr[data-id="+basketId+"] .cost-cell .price:not(.discount)").stop().animateNumbers(parseFloat(delSpaces($(newBasket).find("tr[data-id="+basketId+"] .cost-cell .price:not(.discount)").text())).toFixed(2), 333, true);
					}
					if(parseInt(delSpaces($(oldBasket).find("tr[data-id="+basketId+"] .cost-cell .price.discount strike").text()))!=parseInt(delSpaces($(newBasket).find("tr[data-id="+basketId+"] .cost-cell .price.discount strike").text()))) {
						$(oldBasket).find("tr[data-id="+basketId+"] .cost-cell .price.discount strike").stop().animateNumbers(parseFloat(delSpaces($(newBasket).find("tr[data-id="+basketId+"] .cost-cell .price.discount strike").text())).toFixed(2), 333, true);
					}
					if($(oldBasket).find("tr[data-id="+basketId+"] .cost-cell .price.discount").length && !$(newBasket).find("tr[data-id="+basketId+"] .cost-cell .price.discount").length) {
						...
						var discountPrice = parseFloat(delSpaces($(newBasket).find("tr[data-id="+basketId+"] .cost-cell .price.discount strike").text())).toFixed(2);
