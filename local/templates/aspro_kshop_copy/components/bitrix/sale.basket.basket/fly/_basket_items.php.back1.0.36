				...
				<tr data-id="total_buttons">
					<td>
						<div class="basket_close">
							<a class="button30 close"><span><?=GetMessage("SALE_BACK")?></span></a>
					...
					<td>
						<div class="basket_back">
							<a href="<?=$arParams["PATH_TO_BASKET"]?>" class="button30 gradient back_button"><span><?=GetMessage("GO_TO_BASKET")?></span></a>
