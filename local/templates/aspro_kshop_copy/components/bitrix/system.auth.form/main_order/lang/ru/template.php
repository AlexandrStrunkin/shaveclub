<?
	...
	$MESS["ABOUT_AUTH"] = 'Авторизировавшись, вы сможете управлять своими личными данными, следить за состоянием заказов, а так же получать информацию о проводимых акциях и участвовать в бонусной программе.';
	...
	$MESS["REGISTER_NEW_USER"] = "Продолжить оформление заказа как новый пользователь";
