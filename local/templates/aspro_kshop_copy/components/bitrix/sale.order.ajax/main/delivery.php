...
<div class="section">
	...
	if(!empty($arResult["DELIVERY"]))
	{
		...
		<div class="sale_order_table delivery ">
			<?
					...
					foreach ($arDelivery["PROFILES"] as $profile_id => $arProfile)
					{
						...
						<div class="bx_element prop">
							...
							<input
								...
								onclick="submitForm(); delyverySubmit();"
								/>

							<label for="ID_DELIVERY_<?=$delivery_id?>_<?=$profile_id?>" onclick="BX('ID_DELIVERY_<?=$delivery_id?>_<?=$profile_id?>').checked=true;<?=$extraParams?>submitForm();delyverySubmit();">
								...
								<div class="desc">
									...
									<span class="desc"><!-- click on this should not cause form submit -->
										<?
