...
<?
    ...
    if ($_REQUEST["delivery"])
    {
        ...
        //Set default scale for map
        $arStoreLocation["yandex_scale"]=9;
        //Set default gps
     //   $arStoreLocation["yandex_lat"] = 55.753050;
     //   $arStoreLocation["yandex_lon"] = 37.571135;
                    ...
                    <div class="view_map"><?
                        ...
                        <?$APPLICATION->IncludeComponent(
                                ...
                                Array(
                                    ...
                                    "MAP_WIDTH" => "400",
                                    "MAP_HEIGHT" => "400",
                                    "CONTROLS" => array("TYPECONTROL", "ZOOM", "SMALLZOOM"),
...
<div class="text_mao">Для выбора ПВЗ нажмите на соответствующий элемент в списке справа.</div>