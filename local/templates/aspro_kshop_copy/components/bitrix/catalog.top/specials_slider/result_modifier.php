...
$arTempResult = array();
$arSpecialsCodes = array();

if($arParams["SPECIALS_CODE1"]){
	$arSpecialsCodes[] = trim($arParams["SPECIALS_CODE1"]);
}
if($arParams["SPECIALS_CODE2"]){
	$arSpecialsCodes[] = trim($arParams["SPECIALS_CODE2"]);
}
if($arParams["SPECIALS_CODE3"]){
	$arSpecialsCodes[] = trim($arParams["SPECIALS_CODE3"]);
}
