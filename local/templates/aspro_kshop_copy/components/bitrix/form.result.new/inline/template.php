			...
			<?=$arResult["FORM_HEADER"]?>
				<div class="left-data">
					<?foreach ($arResult["QUESTIONS"] as $FIELD_SID => $arQuestion){?>
						...
						<?if( $arQuestion["STRUCTURE"][0]["FIELD_PARAM"] == 'left' or  $arQuestion["STRUCTURE"][0]["FIELD_TYPE"] == 'textarea'){?>
							<div class="r">
				...
				<div class="right-data">
                    ...
                    foreach ($arResult["QUESTIONS"] as $FIELD_SID => $arQuestion){
						...
						elseif( $arQuestion["STRUCTURE"][0]["FIELD_PARAM"] != 'left' and $arQuestion["STRUCTURE"][0]["FIELD_TYPE"] != 'textarea'){?>
							<div class="r">
								<label class="s"><?=$arQuestion["CAPTION"]?>:<?if ($arQuestion["REQUIRED"] == "Y"):?><span class="star">*</span><?endif;?></label>
								<?
									if( is_array($arResult["FORM_ERRORS"]) && array_key_exists($FIELD_SID, $arResult['FORM_ERRORS']) )
