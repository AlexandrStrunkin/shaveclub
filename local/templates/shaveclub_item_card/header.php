        ...
        <div class="inside-page-col">
                    ...
                    <?
                        ...
                        <li <?if ($i%2 == 0){?> class="orange"<?}?> <?if ($url[1] == "gift"){?> style="width:50% !important"<?}?>>
                            <div>
                                ...
                                <span class="plans-text"><?=$arPlan["PROPERTY_CASSETTE_VALUE"]?> <?if ($url[1] != "gift"){?><span class="rouble">i</span><?} else {?> шт<?}?> </span>
                                <span class="plans-title"><span>Бритвенный станок</span></span>
                                <span class="plans-text"><?=$arPlan["PROPERTY_RAZOR_VALUE"]?> <?if ($url[1] != "gift"){?>  <?if ($arPlan["PROPERTY_RAZOR_VALUE"] != "бесплатно"){?> <span class="rouble">i</span> <?}?> <?} else {?> шт<?}?>  </span>
                                <?if ($url[1] != "gift"){?>
                                    ...
                                    <?} else if ($url[1] == "gift"){?>
                                    <span class="plans-title"><span>Кол-во доставок</span></span>
            ...
            <div class="svoy-plan inside-page">
                ...
                <div class="div">
                    ...
                    <div class="shaving-stock">Запас бритья: <span class="stock-quant"> <?=$stock?> недели</span></div>
                        ...
                        <div class="col-container"><span class="arr"></span><span class="close"></span>
                            <?
                                ...
                                <span class="col"><span>
                                    ...
                                    <span>Пример: <?=$arAll_raz["UF_ZAPAS_SAMPLE"]?> кассеты на 2 месяца.</span></span></span>
                    ...
                    <div class="shaving-stock"><span class="sum"></span> скидка <span></span></div>
